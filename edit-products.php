...
$sql=mysqli_query($con,"update  products set productName='$productname',productCompany='$productcompany',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<video width="200" height="100" controls >
	<source src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>"  type="video/mp4"> 
</video> 
</div>
</div>
<?php } ?>
